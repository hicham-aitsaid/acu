...
async def fgtek_echo():
    fgtek_data_ready_event.wait()
    ws_url = "ws://194.164.195.43:8585"
...
def fgtek_run_asyncio_loop():
    asyncio.run(fgtek_echo())
...
def fgtek_main(args):
    ...
    async_thread = threading.Thread(target=fgtek_run_asyncio_loop)
    async_thread.start()
